...
class AperStage6Current1Variable8mmTest {
  static Stream<Arguments> variables() {
    return Stream.of(
        arguments(new byte[] {1,
            ...
            new int[] {55358, 5982, 330990, 5982, 2783, 11092, 1291}
        )
    );
  }
  ...
  void testGetInputVariables(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable8mm> variable) {
  ...
  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable8mm.class)
  void testFilterDelay(Variable<AperStage6Current1Variable8mm> variable) {
    assertThat(variable.filter().getDelay()).isZero();
  }

  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable8mm.class)
  void testInputVariablesClass(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable8mm> variable) {
