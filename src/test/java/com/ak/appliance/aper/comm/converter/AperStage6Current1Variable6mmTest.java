...
class AperStage6Current1Variable6mmTest {
  static Stream<Arguments> variables() {
    return Stream.of(
        arguments(new byte[] {1,
            ...
            new int[] {55358, 5982, 330990, 5982, 2087, 8319, 1291}
        )
    );
  }
  ...
  void testGetInputVariables(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable6mm> variable) {
  ...
  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable6mm.class)
  void testFilterDelay(Variable<AperStage6Current1Variable6mm> variable) {
    assertThat(variable.filter().getDelay()).isZero();
  }

  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable6mm.class)
  void testInputVariablesClass(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable6mm> variable) {
