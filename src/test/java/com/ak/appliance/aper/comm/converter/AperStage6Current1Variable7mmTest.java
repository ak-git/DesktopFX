...
class AperStage6Current1Variable7mmTest {
  ...
  void testGetInputVariables(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable7mm> variable) {
  ...
  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable7mm.class)
  void testFilterDelay(Variable<AperStage6Current1Variable7mm> variable) {
    assertThat(variable.filter().getDelay()).isZero();
  }

  @ParameterizedTest
  @EnumSource(value = AperStage6Current1Variable7mm.class)
  void testInputVariablesClass(DependentVariable<AperStage5Current1Variable, AperStage6Current1Variable7mm> variable) {
