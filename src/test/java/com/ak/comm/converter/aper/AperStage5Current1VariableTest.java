...
class AperStage5Current1VariableTest {
  static Stream<Arguments> variables() {
    return Stream.of(
        arguments(new byte[] {1,
            ...
            new int[] {55318, 5982, 330990, 5982, 2085, 8319, 2433, 9705, 2781, 11092, 3476, 13864, 1302}
        )
    );
  }
  ...
  @Test
  void testOptions() {
    assertThat(EnumSet.allOf(AperStage5Current1Variable.class).stream().flatMap(v -> v.options().stream()))
        .isEqualTo(
            List.of(
