...
public class AperStage2UnitsVariableTest {
  ...
  public static Object[][] variables() {
    return new Object[][] {
        {new byte[] {1,
            ...
            new int[] {55615, 301400, 301400, -546133, -546132, 1296, 1726}},
    };
  }
  ...
  public void testFilterDelay() {
    Assert.assertTrue(EnumSet.allOf(AperStage2UnitsVariable.class).stream().mapToDouble(value -> value.filter().getDelay())
