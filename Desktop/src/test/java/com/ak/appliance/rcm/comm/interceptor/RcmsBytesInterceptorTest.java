...
class RcmsBytesInterceptorTest {
  private static final Logger LOGGER = Logger.getLogger(RcmsBytesInterceptor.class.getName());
  private final BytesInterceptor<BufferFrame, BufferFrame> interceptor = new RcmsBytesInterceptor();
