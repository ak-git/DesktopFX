...
class FontsTest {
  ...
  void fontProperty() {
    ...
    Assertions.assertThat(Fonts.H1.fontProperty(() -> null).toString()).containsAnyOf("Tahoma", "System").contains("Bold");
    Assertions.assertThat(Fonts.H2.fontProperty(() -> null).toString()).containsAnyOf("Tahoma", "System").contains("Regular");
  }
