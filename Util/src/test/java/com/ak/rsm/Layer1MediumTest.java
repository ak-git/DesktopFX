...
public class Layer1MediumTest {
  ...
  public static Object[][] layer1Medium() {
    ...
    return new Object[][] {
        {new Layer1Medium(measurements), new ValuePair(0.0712, 0.00037)},
    };
  }
  ...
  public void testToString(MediumLayers layers, ValuePair expected) {
    ...
    double l2 = Arrays.stream(new double[] {0.3820381731424676, 0.17605089752329034, 0.39041411042944724, 0.5449045671438306})
