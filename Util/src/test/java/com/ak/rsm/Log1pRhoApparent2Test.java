...
public class Log1pRhoApparent2Test {
  private Log1pRhoApparent2Test() {
  }
  ...
  public static void testValue(double[] rho, double hmm, double smm, double lmm, double rOhm) {
    ...
    double logPredicted = new Log1pRhoApparent2(system).value(Layers.getK12(rho[0], rho[1]), lmm / hmm);
