...
public class Inverse2Test {
  @DataProvider(name = "derivative-resistance-with-indent")
  public static Object[][] derivativeResistanceWithIndent() {
    return new Object[][] {
        {
            List.of(
  ...
  @Test(dataProvider = "derivative-resistance-with-indent", invocationCount = 2, enabled = false)
