...
class InverseTestE7694akProvider {
  ...
  static Stream<Arguments> e17_52_54_s4() {
    ...
    return Stream.of(
        arguments(
            List.of(
                TetrapolarDerivativeMeasurement.milli(0.1).dh(DeltaH.H1.apply(-0.21 * 4)).system4(7.0)
                    .ofOhms(r1, r2, r3, r4,
                        r1 - 0.3080655, r2 - 1.2502451, r3 - 0.7826758, r4 - 1.5915058
                    ),
                TetrapolarDerivativeMeasurement.milli(0.1).dh(DeltaH.H1.apply(-0.21 * 2)).system4(7.0)
                    .ofOhms(r1, r2, r3, r4,
                        r1 - 0.1657916, r2 - 0.6687096, r3 - 0.3425554, r4 - 0.6475226
                    ),
                TetrapolarDerivativeMeasurement.milli(0.1).dh(DeltaH.H1.apply(-0.21)).system4(7.0)
                    .ofOhms(r1, r2, r3, r4,
