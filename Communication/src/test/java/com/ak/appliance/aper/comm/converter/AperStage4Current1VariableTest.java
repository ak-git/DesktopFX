...
class AperStage4Current1VariableTest {
  static Stream<Arguments> variables() {
    return Stream.of(
        arguments(new byte[] {1,
            ...
            new int[] {55358, 5982, 330990, 5982, 1291}
        )
    );
  }
  ...
  void testGetInputVariables(DependentVariable<AperStage3Variable, AperStage4Current1Variable> variable) {
  ...
  @ParameterizedTest
  @EnumSource(value = AperStage4Current1Variable.class)
  void testFilterDelay(Variable<AperStage4Current1Variable> variable) {
    assertThat(variable.filter().getDelay()).isZero();
  }

  @ParameterizedTest
  @EnumSource(value = AperStage4Current1Variable.class)
  void testInputVariablesClass(DependentVariable<AperStage3Variable, AperStage4Current1Variable> variable) {
